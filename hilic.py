...
if __name__ == '__main__':
    ...
    hic_bias_vector = matrix.CtlVector(args.genome, args.resolution[0], {"chrY", "chrM"})
    ...
    hic_matrix = matrix.HicMatrix(args.genome, args.resolution[0], {"chrY", "chrM"})
    ...
    ##ctl_bias_vector = matrix.CtlVector(args.genome, args.resolution[0], {"chrY", "chrM"})
