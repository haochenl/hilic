...
if __name__ == '__main__':
    ...
    hic_matrix = matrix.HicMatrix(args.genome, args.resolution[0])
    ...
    hic_bias_vector = matrix.CtlVector(args.genome, args.resolution[0])
    ...
    ctl_bias_vector = matrix.CtlVector(args.genome, args.resolution[0])
